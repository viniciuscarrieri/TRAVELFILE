                    ...
                    itemBuilder: (context, index) {
                      return Card(
                        ...
                        child: GestureDetector(
                          child: Card(
                            child: ListTile(
                              leading: returnlogo(SeguroFiles[index]),
                              title: Text(
                                SeguroFiles[index].name,
                                style: TextStyle(color: Colors.black),
                              ),
                              onTap: () async {
                                final ref = FirebaseStorage.instance.ref(
                                  SeguroFiles[index].fullPath,
                                );
                                ...
                                showDialog(
                                  ...
                                  builder:
                                      (context) => AlertDialog(
                                        ...
                                        content: Text(
                                          'Deseja excluir o arquivo ${SeguroFiles[index].name}?',
                                        ),
                                        actions: [
                                          TextButton(
                                            onPressed: () {
