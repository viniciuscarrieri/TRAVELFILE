                    ...
                    itemBuilder: (context, index) {
                      return Card(
                        ...
                        child: GestureDetector(
                          child: Card(
                            child: ListTile(
                              leading: returnlogo(TransladoFiles[index]),
                              title: Text(
                                TransladoFiles[index].name,
                                style: TextStyle(color: Colors.black),
                              ),
                              onTap: () async {
                                final ref = FirebaseStorage.instance.ref(
                                  TransladoFiles[index].fullPath,
                                );
                                ...
                                showDialog(
                                  ...
                                  builder:
                                      (context) => AlertDialog(
                                        ...
                                        content: Text(
                                          'Deseja excluir o arquivo ${TransladoFiles[index].name}?',
                                        ),
                                        actions: [
                                          TextButton(
                                            onPressed: () {
